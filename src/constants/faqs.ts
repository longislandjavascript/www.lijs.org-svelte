...
const faqs: FAQS[] = [
  ...
  },
  {
    ...
    a:
      'There is a contact form right below here. Send us a message and we would love to chat more!'
  },
  {
    q: 'Can my company sponsor your group?',
    a:
      'Absolutely! We do not charge for events, so sponsorships help to cover some of our operating costs and to provide food, beverages, and giveaways to our group. Please fill out the contact form below and we will get in tough with you soon.',
  },
  {
